...
namespace Believe.Models.PepTalk;

/// <summary>
/// Get a motivational pep talk from Ted Lasso himself. By default returns the complete
/// pep talk. Add `?stream=true` to get Server-Sent Events (SSE) streaming the pep
/// talk chunk by chunk.
///
...
/// </summary>
public record class PepTalkRetrieveParams : ParamsBase
{
    /// <summary>
