...
public record class TeamMemberListStaffResponse : ModelBase
{
    ...
    public string ID {
        get {
            return Match(medicalStaff: ( x )=>x.ID,
    ...
    public string CharacterID {
        get {
            return Match(medicalStaff: ( x )=>x.CharacterID,
    ...
    public string TeamID {
        get {
            return Match(medicalStaff: ( x )=>x.TeamID,
    ...
    public long YearsWithTeam {
        get {
            return Match(medicalStaff: ( x )=>x.YearsWithTeam,
    ...
    )
    {
        switch (this.Value)
        {
            ...
            case TeamMemberEquipmentManager value:
                ...
                break;
            default:
                throw new BelieveInvalidDataException("Data did not match any variant of TeamMemberListStaffResponse");
...
/// </summary>
    ...
    )
    {
        return this.Value switch
        {
            ...
            _ =>throw new BelieveInvalidDataException("Data did not match any variant of TeamMemberListStaffResponse")
        } ;
    }

    public static implicit operator TeamMemberListStaffResponse (
        TeamMemberMedicalStaff value
    )=> new(value) ;
...
/// </summary>
    public override void Validate()
    {
        ...
        this.Switch((medicalStaff) => medicalStaff.Validate(),
    ...
    int VariantIndex()
    {
        return this.Value switch
        {
            TeamMemberMedicalStaff _=>0, TeamMemberEquipmentManager _=>1, _ =>-1
        } ;
    }
}
