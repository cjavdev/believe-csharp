...
[JsonConverter(typeof(JsonModelConverter<TeamMemberListCoachesPageResponse, TeamMemberListCoachesPageResponseFromRaw>))]
public sealed record class TeamMemberListCoachesPageResponse : JsonModel
{
    public required IReadOnlyList<TeamMemberCoach> Data {
        get {
            ...
            return this._rawData.GetNotNullStruct<ImmutableArray<TeamMemberCoach>>(
                "data"
            );
        }
        init {
