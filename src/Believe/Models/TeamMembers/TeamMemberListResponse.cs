    ...
    )
    {
        switch (this.Value)
        {
            ...
            case TeamMemberEquipmentManager value:
                ...
                break;
            default:
                throw new BelieveInvalidDataException("Data did not match any variant of TeamMemberListResponse");
...
/// </summary>
    ...
    )
    {
        return this.Value switch
        {
            ...
            _ =>throw new BelieveInvalidDataException("Data did not match any variant of TeamMemberListResponse")
        } ;
    }

    public static implicit operator TeamMemberListResponse (
        TeamMemberPlayer value
    )=> new(value) ;
