...
/// </summary>
[JsonConverter(typeof(TeamMemberListResponseConverter))]
public record class TeamMemberListResponse : ModelBase
{
    ...
    public TeamMemberListResponse(TeamMemberPlayer value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberListResponse(TeamMemberCoach value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberListResponse(TeamMemberMedicalStaff value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberListResponse(TeamMemberEquipmentManager value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberListResponse(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new BelieveInvalidDataException(
                    "Data did not match any variant of TeamMemberListResponse"
                );
        }
    }
    ...
    public static implicit operator TeamMemberListResponse(TeamMemberPlayer value) => new(value);

    public static implicit operator TeamMemberListResponse(TeamMemberCoach value) => new(value);

    public static implicit operator TeamMemberListResponse(TeamMemberMedicalStaff value) =>
        new(value);

    public static implicit operator TeamMemberListResponse(TeamMemberEquipmentManager value) =>
        new(value);
    ...
    public virtual bool Equals(TeamMemberListResponse? other) =>
        other != null
...
sealed class TeamMemberListResponseConverter : JsonConverter<TeamMemberListResponse>
{
    public override TeamMemberListResponse? Read(
    ...
    )
    {
        ...
        switch (memberType)
        {
            ...
            default:
            {
                return new TeamMemberListResponse(element);
            }
        }
    }
