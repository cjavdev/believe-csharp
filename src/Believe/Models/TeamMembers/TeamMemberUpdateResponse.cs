...
public record class TeamMemberUpdateResponse : ModelBase
{
    ...
    public TeamMemberUpdateResponse(TeamMemberPlayer value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberUpdateResponse(TeamMemberCoach value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberUpdateResponse(TeamMemberMedicalStaff value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberUpdateResponse(TeamMemberEquipmentManager value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new BelieveInvalidDataException(
                    "Data did not match any variant of TeamMemberUpdateResponse"
                );
        }
    }
    ...
    public static implicit operator TeamMemberUpdateResponse(TeamMemberPlayer value) => new(value);

    public static implicit operator TeamMemberUpdateResponse(TeamMemberCoach value) => new(value);

    public static implicit operator TeamMemberUpdateResponse(TeamMemberMedicalStaff value) =>
        new(value);

    public static implicit operator TeamMemberUpdateResponse(TeamMemberEquipmentManager value) =>
        new(value);
