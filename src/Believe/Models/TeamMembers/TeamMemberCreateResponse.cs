...
/// </summary>
[JsonConverter(typeof(TeamMemberCreateResponseConverter))]
public record class TeamMemberCreateResponse : ModelBase
{
    ...
    public TeamMemberCreateResponse(TeamMemberPlayer value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberCreateResponse(TeamMemberCoach value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberCreateResponse(TeamMemberMedicalStaff value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberCreateResponse(TeamMemberEquipmentManager value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberCreateResponse(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new BelieveInvalidDataException(
                    "Data did not match any variant of TeamMemberCreateResponse"
                );
        }
    }
    ...
    public static implicit operator TeamMemberCreateResponse(TeamMemberPlayer value) => new(value);

    public static implicit operator TeamMemberCreateResponse(TeamMemberCoach value) => new(value);

    public static implicit operator TeamMemberCreateResponse(TeamMemberMedicalStaff value) =>
        new(value);

    public static implicit operator TeamMemberCreateResponse(TeamMemberEquipmentManager value) =>
        new(value);
    ...
    public virtual bool Equals(TeamMemberCreateResponse? other) =>
        other != null
...
sealed class TeamMemberCreateResponseConverter : JsonConverter<TeamMemberCreateResponse>
{
    public override TeamMemberCreateResponse? Read(
    ...
    )
    {
        ...
        switch (memberType)
        {
            ...
            default:
            {
                return new TeamMemberCreateResponse(element);
            }
        }
    }
    ...
    public override void Write(
        ...
        TeamMemberCreateResponse value,
        JsonSerializerOptions options
    )
    {
