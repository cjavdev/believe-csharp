...
public record class TeamMemberCreateResponse : ModelBase
{
    ...
    public TeamMemberCreateResponse (
    ...
    )
    {
        switch (this.Value)
        {
            ...
            case TeamMemberEquipmentManager value:
                ...
                break;
            default:
                throw new BelieveInvalidDataException("Data did not match any variant of TeamMemberCreateResponse");
...
/// </summary>
    ...
    )
    {
        return this.Value switch
        {
            ...
            _ =>throw new BelieveInvalidDataException("Data did not match any variant of TeamMemberCreateResponse")
        } ;
    }

    public static implicit operator TeamMemberCreateResponse (
        TeamMemberPlayer value
    )=> new(value) ;
