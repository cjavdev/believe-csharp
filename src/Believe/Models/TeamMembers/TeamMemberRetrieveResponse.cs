...
/// </summary>
[JsonConverter(typeof(TeamMemberRetrieveResponseConverter))]
public record class TeamMemberRetrieveResponse : ModelBase
{
    ...
    public TeamMemberRetrieveResponse(TeamMemberPlayer value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberRetrieveResponse(TeamMemberCoach value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberRetrieveResponse(TeamMemberMedicalStaff value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberRetrieveResponse(TeamMemberEquipmentManager value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public TeamMemberRetrieveResponse(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new BelieveInvalidDataException(
                    "Data did not match any variant of TeamMemberRetrieveResponse"
                );
        }
    }
    ...
    public static implicit operator TeamMemberRetrieveResponse(TeamMemberPlayer value) =>
        new(value);

    public static implicit operator TeamMemberRetrieveResponse(TeamMemberCoach value) => new(value);

    public static implicit operator TeamMemberRetrieveResponse(TeamMemberMedicalStaff value) =>
        new(value);

    public static implicit operator TeamMemberRetrieveResponse(TeamMemberEquipmentManager value) =>
        new(value);
    ...
    public virtual bool Equals(TeamMemberRetrieveResponse? other) =>
        other != null
...
sealed class TeamMemberRetrieveResponseConverter : JsonConverter<TeamMemberRetrieveResponse>
{
    public override TeamMemberRetrieveResponse? Read(
    ...
    )
    {
        ...
        switch (memberType)
        {
            ...
            default:
            {
                return new TeamMemberRetrieveResponse(element);
            }
        }
    }
    ...
    public override void Write(
        ...
        TeamMemberRetrieveResponse value,
        JsonSerializerOptions options
    )
    {
