...
public record class TeamMemberRetrieveResponse : ModelBase
{
    ...
    public TeamMemberRetrieveResponse (
    ...
    )
    {
        switch (this.Value)
        {
            ...
            case TeamMemberEquipmentManager value:
                ...
                break;
            default:
                throw new BelieveInvalidDataException("Data did not match any variant of TeamMemberRetrieveResponse");
...
/// </summary>
    ...
    )
    {
        return this.Value switch
        {
            ...
            _ =>throw new BelieveInvalidDataException("Data did not match any variant of TeamMemberRetrieveResponse")
        } ;
    }

    public static implicit operator TeamMemberRetrieveResponse (
        TeamMemberPlayer value
    )=> new(value) ;
