...
public record class TeamCreateParams : ParamsBase
{
    ...
    public required long CultureScore
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullStruct<long>("culture_score");
        }
    ...
    public required long FoundedYear
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullStruct<long>("founded_year");
        }
    ...
    public required ApiEnum<string, League> League
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<ApiEnum<string, League>>("league");
        }
    ...
    public required string Stadium
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("stadium");
        }
    ...
    public required TeamValues Values
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<TeamValues>("values");
        }
    ...
    public AnnualBudgetGbp? AnnualBudgetGbp
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<AnnualBudgetGbp>("annual_budget_gbp");
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TeamCreateParams(TeamCreateParams teamCreateParams)
        : base(teamCreateParams)
    {
...
public record class AnnualBudgetGbp : ModelBase
{
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new BelieveInvalidDataException(
                    "Data did not match any variant of AnnualBudgetGbp"
                );
        }
    }
    ...
    public static implicit operator AnnualBudgetGbp(double value) => new(value);

    public static implicit operator AnnualBudgetGbp(string value) => new(value);
