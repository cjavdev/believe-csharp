...
public record class QuoteRetrieveParams : ParamsBase
{
    ...
    [SetsRequiredMembers]
    public QuoteRetrieveParams (QuoteRetrieveParams quoteRetrieveParams) : base(
        quoteRetrieveParams
    )
    ...
    public virtual bool Equals(QuoteRetrieveParams? other)
    {
        ...
        return (this.QuoteID?.Equals(other.QuoteID) ?? other.QuoteID == null)&&this._rawHeaderData.Equals(other._rawHeaderData)&&this._rawQueryData.Equals(other._rawQueryData) ;
    }
