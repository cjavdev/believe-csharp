...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<MatchCompletedWebhookEvent, MatchCompletedWebhookEventFromRaw>))]
public sealed record class MatchCompletedWebhookEvent : JsonModel
{
    ...
    public required MatchCompletedWebhookEventData Data {
        get {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<MatchCompletedWebhookEventData>(
                "data"
            );
        }
    ...
    public required ApiEnum<string, MatchCompletedWebhookEventEventType> EventType {
        get {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, MatchCompletedWebhookEventEventType>>(
                "event_type"
            );
        }
    ...
    [SetsRequiredMembers]
    public MatchCompletedWebhookEvent (
        MatchCompletedWebhookEvent matchCompletedWebhookEvent
...
/// Data payload for a match completed event.
/// </summary>
[JsonConverter(typeof(JsonModelConverter<MatchCompletedWebhookEventData, MatchCompletedWebhookEventDataFromRaw>))]
public sealed record class MatchCompletedWebhookEventData : JsonModel
{
    ...
    public required ApiEnum<string, MatchCompletedWebhookEventDataMatchType> MatchType {
        get {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, MatchCompletedWebhookEventDataMatchType>>(
                "match_type"
            );
        }
    ...
    public required ApiEnum<string, MatchCompletedWebhookEventDataResult> Result {
        get {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, MatchCompletedWebhookEventDataResult>>(
                "result"
            );
        }
...
}sealed class MatchCompletedWebhookEventDataMatchTypeConverter : JsonConverter<MatchCompletedWebhookEventDataMatchType>
{
...
}sealed class MatchCompletedWebhookEventDataResultConverter : JsonConverter<MatchCompletedWebhookEventDataResult>
{
...
{
    MatchCompleted
}sealed class MatchCompletedWebhookEventEventTypeConverter : JsonConverter<MatchCompletedWebhookEventEventType>
{
