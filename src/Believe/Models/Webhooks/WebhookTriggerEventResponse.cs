...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<WebhookTriggerEventResponse, WebhookTriggerEventResponseFromRaw>))]
public sealed record class WebhookTriggerEventResponse : JsonModel
{
    ...
    public required IReadOnlyList<Delivery> Deliveries {
        get {
            ...
            return this._rawData.GetNotNullStruct<ImmutableArray<Delivery>>(
                "deliveries"
            );
        }
        init {
    ...
    public required ApiEnum<string, WebhookTriggerEventResponseEventType> EventType {
        get {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, WebhookTriggerEventResponseEventType>>(
                "event_type"
            );
        }
    ...
    [SetsRequiredMembers]
    public WebhookTriggerEventResponse (
        WebhookTriggerEventResponse webhookTriggerEventResponse
...
public sealed record class Delivery : JsonModel
{
    ...
    #pragma warning disable CS8618
    [SetsRequiredMembers]
    public Delivery (Delivery delivery) : base(delivery)
    {  }
    #pragma warning restore CS8618
    ...
    public static Delivery FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    { return new(FrozenDictionary.ToFrozenDictionary(rawData)); }
...
{
    /// <inheritdoc/>
    public Delivery FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
...
}sealed class WebhookTriggerEventResponseEventTypeConverter : JsonConverter<WebhookTriggerEventResponseEventType>
{
    ...
    )
    {
        JsonSerializer.Serialize(writer, value switch
        {
            ...
            WebhookTriggerEventResponseEventType.TeamMemberTransferred=>"team_member.transferred",
