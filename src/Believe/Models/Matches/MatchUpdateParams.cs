...
public record class MatchUpdateParams : ParamsBase
{
    ...
    public ApiEnum<string, MatchType>? MatchType {
        get {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<ApiEnum<string, MatchType>>(
                "match_type"
            );
        }
    ...
    [SetsRequiredMembers]
    public MatchUpdateParams (MatchUpdateParams matchUpdateParams) : base(
        matchUpdateParams
    )
    {
    ...
    public virtual bool Equals(MatchUpdateParams? other)
    {
        ...
        return (this.MatchID?.Equals(other.MatchID) ?? other.MatchID == null)&&this._rawHeaderData.Equals(other._rawHeaderData)&&this._rawQueryData.Equals(other._rawQueryData)&&this._rawBodyData.Equals(
            other._rawBodyData
        ) ;
    }
...
public record class MatchUpdateParamsTicketRevenueGbp : ModelBase
{
    ...
    public MatchUpdateParamsTicketRevenueGbp (
    ...
    public void Switch(Action<double> @double, Action<string> @string)
    {
        switch (this.Value)
        {
            ...
            case string value:
                ...
                break;
            default:
                throw new BelieveInvalidDataException("Data did not match any variant of MatchUpdateParamsTicketRevenueGbp");
...
/// </summary>
    ...
    (Func<double, T> @double, Func<string, T> @string)
    {
        return this.Value switch
        {
            ...
            _ =>throw new BelieveInvalidDataException("Data did not match any variant of MatchUpdateParamsTicketRevenueGbp")
        } ;
    }

    public static implicit operator MatchUpdateParamsTicketRevenueGbp (
        double value
    )=> new(value) ;
...
sealed class MatchUpdateParamsTicketRevenueGbpConverter : JsonConverter<MatchUpdateParamsTicketRevenueGbp?>
{
