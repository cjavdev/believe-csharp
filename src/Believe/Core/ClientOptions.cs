...
/// </summary>
    ...
    Lazy<string> _baseUrl = new(() => Environment.GetEnvironmentVariable("BELIEVE_BASE_URL") ?? EnvironmentUrl.Production);
    /// <summary>
...
/// <see cref="IBelieveClient.WithRawResponse"/>, don't perform validation until deserialization
/// is triggered.</para>
/// </summary>
...
/// </summary>
    ...
    Lazy<string> _apiKey = new(() => Environment.GetEnvironmentVariable("BELIEVE_API_KEY")??throw new BelieveInvalidDataException(string.Format("{0} cannot be null",
    nameof(ApiKey)), new ArgumentNullException(nameof(ApiKey))));
