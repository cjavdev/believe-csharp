...
/// </summary>
public record class ApiEnum<TRaw, TEnum>where TEnum : struct, Enum
{
    /// <summary>
    ...
    public TRaw Raw()
    {
        try
        {
            return JsonSerializer.Deserialize<TRaw>(this.Json, ModelBase.SerializerOptions)
                ?? throw new BelieveInvalidDataException($"{nameof(this.Json)} cannot be null");
        }
...
/// </summary>
    public void Validate()
    {
        if (!Enum.IsDefined(typeof(TEnum), Value())) {
            throw new BelieveInvalidDataException("Invalid enum value");
        }
    }
    ...
    public static implicit operator TRaw (
    ...
    public static implicit operator ApiEnum<TRaw, TEnum> (
        TRaw value
...
}sealed class ApiEnumConverter<TRaw,
TEnum> : JsonConverter<ApiEnum<TRaw, TEnum>>where TEnum : struct, Enum
{
