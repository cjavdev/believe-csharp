...
public abstract record class ModelBase
{
    ...
    internal static readonly JsonSerializerOptions SerializerOptions = new()
    {
        ...
        new ApiEnumConverter<string, Webhooks::TeamMemberTransferredWebhookEventDataMemberType>(),
        new ApiEnumConverter<string, Webhooks::TeamMemberTransferredWebhookEventDataTransferType>(),
    ...
    internal static readonly JsonSerializerOptions ToStringSerializerOptions = new(SerializerOptions) { WriteIndented = true };
