...
public sealed class PressService : IPressService
{
    ...
    /// <inheritdoc/>
    public IPressService WithOptions(
    ...
    public PressService (IBelieveClient client)
    {
        ...
        _withRawResponse =new(
            () => new PressServiceWithRawResponse(client.WithRawResponse)
        ) ;
    }
    ...
    {
        using var response = await this.WithRawResponse.Simulate(parameters, cancellationToken).ConfigureAwait(false);
...
public sealed class PressServiceWithRawResponse : IPressServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public IPressServiceWithRawResponse WithOptions(
        Func<ClientOptions, ClientOptions> modifier
    )
    {
    ...
    )
    {
        ...
        return new(response, async ( token )=>{
            var deserializedResponse = await response.Deserialize<PressSimulateResponse>(token).ConfigureAwait(false);
