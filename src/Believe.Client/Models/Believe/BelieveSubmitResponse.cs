...
namespace Believe.Client.Models.Believe;
...
public sealed record class BelieveSubmitResponse : JsonModel
{
    ...
    public required string ActionSuggestion
    {
        get
        {
            ...
            return this._rawData.GetNotNullClass<string>("action_suggestion");
        }
    ...
    public required long BelieveScore
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<long>("believe_score");
        }
    ...
    public required string GoldfishWisdom
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<string>("goldfish_wisdom");
        }
    ...
    public required string RelevantQuote
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<string>("relevant_quote");
        }
    ...
    public required string TedResponse
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<string>("ted_response");
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BelieveSubmitResponse(BelieveSubmitResponse believeSubmitResponse)
        : base(believeSubmitResponse) { }
#pragma warning restore CS8618

    public BelieveSubmitResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
