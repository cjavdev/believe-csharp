...
namespace Believe.Client.Models.Episodes;
...
public record class EpisodeCreateParams : ParamsBase
{
    ...
    public required string AirDate
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullClass<string>("air_date");
        }
    ...
    public required IReadOnlyList<string> CharacterFocus
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullStruct<ImmutableArray<string>>("character_focus");
        }
        init
        {
    ...
    public required string Director
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("director");
        }
    ...
    public required long EpisodeNumber
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullStruct<long>("episode_number");
        }
    ...
    public required string MainTheme
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("main_theme");
        }
    ...
    public required long RuntimeMinutes
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullStruct<long>("runtime_minutes");
        }
    ...
    public required long Season
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullStruct<long>("season");
        }
    ...
    public required string Synopsis
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("synopsis");
        }
    ...
    public required string TedWisdom
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("ted_wisdom");
        }
    ...
    public required string Writer
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("writer");
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public EpisodeCreateParams(EpisodeCreateParams episodeCreateParams)
        : base(episodeCreateParams)
    {
