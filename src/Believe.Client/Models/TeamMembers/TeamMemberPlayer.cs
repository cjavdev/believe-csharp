...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TeamMemberPlayer(TeamMemberPlayer teamMemberPlayer)
        : base(teamMemberPlayer) { }
...
{
    /// <inheritdoc/>
    public TeamMemberPlayer FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
