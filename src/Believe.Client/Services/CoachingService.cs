...
public sealed class CoachingService : ICoachingService
{
    ...
    /// <inheritdoc/>
    public ICoachingService WithOptions(Func<ClientOptions, ClientOptions> modifier)
    {
    ...
    public CoachingService(IBelieveClient client)
    {
        ...
        _withRawResponse = new(() => new CoachingServiceWithRawResponse(client.WithRawResponse));
        _principles = new(() => new PrincipleService(client));
    }

    readonly Lazy<IPrincipleService> _principles;
    public IPrincipleService Principles
    {
...
public sealed class CoachingServiceWithRawResponse : ICoachingServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public ICoachingServiceWithRawResponse WithOptions(Func<ClientOptions, ClientOptions> modifier)
    {
