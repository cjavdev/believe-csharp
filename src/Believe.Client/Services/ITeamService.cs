...
using Believe.Client.Services.Teams;
...
public interface ITeamService
{
    ...
    /// </summary>
    Task<Team> Create(TeamCreateParams parameters, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Team> Update(TeamUpdateParams parameters, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task Delete(TeamDeleteParams parameters, CancellationToken cancellationToken = default);
...
public interface ITeamServiceWithRawResponse
{
    ...
    /// <para>The original service is not modified.</para>
    /// </summary>
    ITeamServiceWithRawResponse WithOptions(Func<ClientOptions, ClientOptions> modifier);
