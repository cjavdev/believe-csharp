...
using Believe.Client.Services.Matches;
...
public interface IMatchService
{
    ...
    /// </summary>
    Task<Match> Create(MatchCreateParams parameters, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Match> Update(MatchUpdateParams parameters, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task Delete(MatchDeleteParams parameters, CancellationToken cancellationToken = default);
...
public interface IMatchServiceWithRawResponse
{
    ...
    /// <para>The original service is not modified.</para>
    /// </summary>
    IMatchServiceWithRawResponse WithOptions(Func<ClientOptions, ClientOptions> modifier);
