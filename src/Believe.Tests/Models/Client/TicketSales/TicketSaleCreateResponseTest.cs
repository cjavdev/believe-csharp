...
public class TicketSaleCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TicketSaleCreateResponse
        {
            ID = "ts-001",
            BuyerName = "Mae Green",
            Currency = "GBP",
            Discount = "9.00",
            MatchID = "match-001",
            PurchaseMethod = TicketSaleCreateResponsePurchaseMethod.Online,
            Quantity = 2,
            Subtotal = "90.00",
            Tax = "16.20",
            Total = "97.20",
        ...
        ApiEnum<string, TicketSaleCreateResponsePurchaseMethod> expectedPurchaseMethod =
            TicketSaleCreateResponsePurchaseMethod.Online;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TicketSaleCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        TicketSaleCreateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TicketSaleCreateResponsePurchaseMethodTest : TestBase
{
    [Theory]
    [InlineData(TicketSaleCreateResponsePurchaseMethod.Online)]
    [InlineData(TicketSaleCreateResponsePurchaseMethod.BoxOffice)]
    [InlineData(TicketSaleCreateResponsePurchaseMethod.WillCall)]
    [InlineData(TicketSaleCreateResponsePurchaseMethod.Phone)]
    public void Validation_Works(TicketSaleCreateResponsePurchaseMethod rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, TicketSaleCreateResponsePurchaseMethod> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(TicketSaleCreateResponsePurchaseMethod.WillCall)]
    [InlineData(TicketSaleCreateResponsePurchaseMethod.Phone)]
    public void SerializationRoundtrip_Works(TicketSaleCreateResponsePurchaseMethod rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, TicketSaleCreateResponsePurchaseMethod> value = rawValue;
