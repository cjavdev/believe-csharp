...
public class TicketSaleListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TicketSaleListResponse
        {
            ID = "ts-001",
            BuyerName = "Mae Green",
            Currency = "GBP",
        ...
        ApiEnum<string, TicketSaleListResponsePurchaseMethod> expectedPurchaseMethod =
            TicketSaleListResponsePurchaseMethod.Online;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TicketSaleListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        TicketSaleListResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TicketSaleListResponsePurchaseMethodTest : TestBase
{
    [Theory]
    [InlineData(TicketSaleListResponsePurchaseMethod.Online)]
    [InlineData(TicketSaleListResponsePurchaseMethod.BoxOffice)]
    [InlineData(TicketSaleListResponsePurchaseMethod.WillCall)]
    [InlineData(TicketSaleListResponsePurchaseMethod.Phone)]
    public void Validation_Works(TicketSaleListResponsePurchaseMethod rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, TicketSaleListResponsePurchaseMethod> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(TicketSaleListResponsePurchaseMethod.WillCall)]
    [InlineData(TicketSaleListResponsePurchaseMethod.Phone)]
    public void SerializationRoundtrip_Works(TicketSaleListResponsePurchaseMethod rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, TicketSaleListResponsePurchaseMethod> value = rawValue;
