...
public class CharacterServiceTest : TestBase
{
    ...
    {
        var character = await this.client.Characters.Create(new()
        {
    ...
    {
        var character = await this.client.Characters.Retrieve("character_id",
    ...
    {
        var character = await this.client.Characters.Update("character_id",
        new(), TestContext.Current.CancellationToken);
        character.Validate();
    }
    ...
    {
        await this.client.Characters.Delete("character_id",
        new(), TestContext.Current.CancellationToken);
    }
    ...
    {
        await this.client.Characters.GetQuotes("character_id",
        new(), TestContext.Current.CancellationToken);
    }
}