...
public class EpisodeServiceTest : TestBase
{
    ...
    {
        var episode = await this.client.Episodes.Create(new()
        {
            AirDate = "2020-10-02",
            CharacterFocus =
            [
    ...
    {
        var episode = await this.client.Episodes.Retrieve("episode_id",
    ...
    {
        var episode = await this.client.Episodes.Update("episode_id",
        new(), TestContext.Current.CancellationToken);
        episode.Validate();
    }
    ...
    {
        await this.client.Episodes.Delete("episode_id",
        new(), TestContext.Current.CancellationToken);
    }
    ...
    {
        await this.client.Episodes.GetWisdom("episode_id",
        new(), TestContext.Current.CancellationToken);
    }
}