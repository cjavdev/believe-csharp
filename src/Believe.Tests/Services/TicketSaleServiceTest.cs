...
public class TicketSaleServiceTest : TestBase
{
    ...
    {
        var ticketSale = await this.client.TicketSales.Create(new()
        {
            BuyerName = "Mae Green",
            Currency = "GBP",
            Discount = "9.00",
    ...
    {
        var ticketSale = await this.client.TicketSales.Retrieve("ticket_sale_id",
    ...
    {
        var ticketSale = await this.client.TicketSales.Update("ticket_sale_id",
        new(), TestContext.Current.CancellationToken);
        ticketSale.Validate();
    }
    ...
    {
        await this.client.TicketSales.Delete("ticket_sale_id",
        new(), TestContext.Current.CancellationToken);
    }
}