...
public class TeamServiceTest : TestBase
{
    ...
    {
        var team = await this.client.Teams.Create(new()
        {
            CultureScore = 70,
            FoundedYear = 1895,
    ...
    {
        var team = await this.client.Teams.Retrieve("team_id",
    ...
    {
        var team = await this.client.Teams.Update("team_id",
        new(), TestContext.Current.CancellationToken);
        team.Validate();
    }
    ...
    {
        await this.client.Teams.Delete("team_id",
        new(), TestContext.Current.CancellationToken);
    }
    ...
    {
        await this.client.Teams.GetCulture("team_id",
        new(), TestContext.Current.CancellationToken);
    }
    ...
    {
        var teams = await this.client.Teams.GetRivals("team_id",
        new(), TestContext.Current.CancellationToken);
    ...
    {
        var fileUploads = await this.client.Teams.ListLogos("team_id",
        new(), TestContext.Current.CancellationToken);
